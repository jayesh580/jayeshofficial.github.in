...
$diff1 = $_POST['diff'];
$diffy = mysqli_real_escape_string($conn, $diff1);
...
$question_id4="SELECT * FROM question WHERE Sub_id='$sub_id' AND Br_id='$br_id' AND Marks='10' AND Difficulty='$diffy' order by rand() limit 20";
$question10=mysqli_query($conn,$question_id4)or die(mysqli_error($conn));
$question_id5="SELECT * FROM question WHERE Sub_id='$sub_id' AND Br_id='$br_id' AND Marks='5' AND Type='Short' AND Difficulty='$diffy' order by rand() limit 20";
$question5brief = mysqli_query($conn,$question_id5)or die(mysqli_error($conn));
$question_id6="SELECT * FROM question WHERE Sub_id='$sub_id' AND Br_id='$br_id' AND Marks='5' AND Type='Defination' AND Difficulty='$diffy' order by rand() limit 20";
